...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/31 08:54:34 by msabir            #+#    #+#             */
/*   Updated: 2026/01/03 02:49:18 by msabir           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			minimap_draw_single_tile(t_game *game, int row_off,
				int col_off);
void			minimap_draw_player_pixel(t_game *game, int x, int y,
				int radius);
void			set_values(t_intersect *intersect, double x_next, double y_next,
					t_ray *ray);
...
void			draw_textured_slice(t_game *game, int x, t_intersect hit,
					t_ray *ray);
